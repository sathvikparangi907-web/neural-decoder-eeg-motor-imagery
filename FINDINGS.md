...
Second cause, still being addressed: pooling all four classes at C3/Cz/C4 cancels a
lateralised effect. Analysis 5, which is a class *contrast* on the same data, passes cleanly
with correct contralateral lateralisation — which is the evidence that the signal is there
and the pooling is what hides it.
